...
TARIFFS_DATA: list[dict[str, Any]] = [
    {
        ...
        "description_html": (
            ...
            "высокая скорость · 23 локации · обход блокировок и белых "
            "списков."
        ),
        "devices": 2,
        "sort_order": 0,
    ...
    # передаётся в провайдера, но в карточке тарифа **намеренно не
    # упоминается** (маркетинговое решение 2026-05-13: «не вызывать
    # ожиданий, что есть лимит»). Цены оставляем как были.
    #
    ...
    # подписок на Ultra нет, поэтому строка тарифа + всех durations сносится.
    {
        ...
        "name": "Basic",
        "description_html": (
            "<b>2 устройства</b>. Безлимитный трафик · высокая скорость · "
            "23 локации · обход блокировок и белых списков."
        ),
        "devices": 2,
        "sort_order": 10,
    ...
    },
    {
        ...
        "name": "Plus",
        "description_html": (
            "<b>4 устройства</b>. Безлимитный трафик · высокая скорость · "
            "23 локации · обход блокировок и белых списков."
        ),
        "devices": 4,
        "sort_order": 20,
    ...
    },
    {
        ...
        "name": "Max",
        "description_html": (
            "<b>10 устройств</b>. Безлимитный трафик · высокая скорость · "
            "23 локации · обход блокировок и белых списков."
        ),
        "devices": 10,
        "sort_order": 40,
...
DEFAULT_TEXTS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "value_html": (
            ...
            "использования. Мы предоставляем доступ к серверам по всему "
            "миру, поддерживаем все популярные клиенты (iOS, Android, "
            "Windows, macOS, Linux) и работаем без логов.\n\n"
            "Если возникли вопросы — напиши в раздел «Поддержка» в "
            "главном меню."
        ),
        "description": (
            "Текст раздела «О проекте» в главном меню. Под ним — "
            "кнопки btn.about.privacy / btn.about.terms / btn.about.channel."
        ),
    },
    {
    ...
    {
        "key": "subscription_suspended_by_admin",
        "value_html": (
            "<b>Ваш ключ #{key_id} приостановлен администратором.</b>\n"
            "Причина: {reason}\n\n"
            "Доступ временно отключён. Если это ошибка — напишите в поддержку."
        ),
        "description": (
            "Уведомление юзеру о приостановке ключа админом (обратимая операция)."
        ),
    },
    {
        "key": "subscription_resumed_by_admin",
        "value_html": (
            "<b>Ваш ключ #{key_id} снова активен.</b>\n"
            "Доступ восстановлен — можете подключаться."
        ),
        "description": "Уведомление юзеру о возобновлении ключа после suspend.",
    },
    {
